...
This is a template repository for desktop app creation with [electron (v28)](https://www.electronjs.org/de/), [angular (v17)](https://angular.dev/) and [better-sqlite3 (v8)](https://github.com/WiseLibs/better-sqlite3).
